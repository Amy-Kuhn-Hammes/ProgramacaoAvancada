        ...
        while len(fila) >0:
            ...
            for i in range(len(aux)):
                ...
                if x == endP[0] and y == endP[1]: 
                    ...
                    self.__path = temp
                    return temp 
                if x < len(matrix) and x >= 0 and y < len(matrix[0]) and y >= 0 and auxM[x][y] == 0 and matrix[x][y] == 0 and (pos == None or not (x == pos[0] and y == pos[1])):
                    auxM[x][y] = 1
                    temp = fila[0][1].copy()
                    temp.append([x,y])
